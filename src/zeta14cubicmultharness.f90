...
!     a data file called "inputs4.nml". Obviously the source code must have access to this file. This input file contains one additional
...
subroutine alphasum(MTM,rae,pcsum)
  ...
  integer       :: K,ip,mc,i,jj
  integer(dp1)  :: MTM,numbercalc,nchalf
...
subroutine mgausssum(m,ip,csum)
  ...
  integer       :: m,ip,MIT,icj(0:50),i,k,j,m1(50),mmax,jj
  integer(dp1)  :: L(0:50)
...
subroutine q(m,nit,ip,qq)
  ...
  !      con5 is actually the multiplicative factor in the recursive scheme. Also used for t5
